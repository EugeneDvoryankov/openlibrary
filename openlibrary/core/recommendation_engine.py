...
def new_recommendations(user_id):
    ...
    #subject_list = get_subjects(user_id)    # hard coded as ['science_fiction']

    recommendations = []

    for author_id in author_list:
        # Fetch works by the author
        # TODO fetch works by the author not already in my shelves.
    ...
    for subject in subject_list:
        # Fetch works by the subject
        # TODO fetch works by the subject not already in my shelves.
